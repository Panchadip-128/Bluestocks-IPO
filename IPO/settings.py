...
SECRET_KEY = "django-insecure-*wim1!%3i!47^4d1+kgkcb9=*o0+2yy0$womyv*&apv&y2*%3g"
...
AUTH_USER_MODEL = 'ipo_app.User'  # Replace 'ipo_app' with the name of your app
...
DATABASES = {
    'default': {
        ...
        'NAME': 'panchadip',  # The name of the new database
        'USER': 'postgres',  # Your PostgreSQL username
        'PASSWORD': 'panchadip',  # The correct password
...
# Email configuration for sending emails via Gmail (production or testing)
